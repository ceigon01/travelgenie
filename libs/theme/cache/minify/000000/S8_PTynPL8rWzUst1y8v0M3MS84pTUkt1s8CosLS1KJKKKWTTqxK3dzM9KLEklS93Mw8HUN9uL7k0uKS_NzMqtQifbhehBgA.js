    ...
    if (!touchM) {
        ...
        $(window).ready(function () {
            ...
            var jscolor = {
                ...
                getDir: function () {
                    if (!jscolor.dir) {
                        ...
                        jscolor.dir = !1 !== c ? c : "http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/js/"
                    }
                    return jscolor.dir
                },
                detectDir: function () {
                ...
                fireEvent: function (c, e) {
                    if (c)if (document.createEvent) {
                        ...
                        b.initEvent(e, !0, !0);
                        c.dispatchEvent(b)
                    } else if (document.createEventObject)b = document.createEventObject(), c.fireEvent("on" + e, b); else if (c["on" + e])c["on" + e]()
                },
                getElementPos: function (c) {
                    var e = c, b = 0, m = 0;
                    if (e.offsetParent) {
                        do b += e.offsetLeft, m += e.offsetTop; while (e = e.offsetParent)
                    }
                    for (; (c = c.parentNode) && "BODY" !== c.nodeName.toUpperCase();)b -= c.scrollLeft, m -= c.scrollTop;
                    return [b, m]
                },
                ...
                URI: function (c) {
                    function e(b) {
                        for (var c = ""; b;)if ("../" === b.substr(0, 3) || "./" === b.substr(0, 2))b = b.replace(/^\.+/, "").substr(1); else if ("/./" === b.substr(0, 3) || "/." === b)b = "/" + b.substr(3); else if ("/../" === b.substr(0, 4) || "/.." === b)b = "/" + b.substr(4), c = c.replace(/\/?[^\/]*$/, ""); else if ("." === b || ".." === b)b = ""; else {
                            var e = b.match(/^\/?[^\/]*/)[0];
                            b = b.substr(e.length);
                            c += e
                        }
                ...
                color: function (c, e) {
                    ...
                    function w() {
                        ...
                        var c = Math.round(d.hsv[0] / 6 * (jscolor.images.pad[0] - 1)), a = Math.round((1 - d.hsv[a]) * (jscolor.images.pad[1] - 1));
                        ...
                        switch (p) {
                            case 0:
                                ...
                                break;
                            case 1:
                                var g, l = [d.hsv[2], 0, 0], a = Math.floor(d.hsv[0]), h = a % 2 ? d.hsv[0] - a : 1 - (d.hsv[0] - a);
                                switch (a) {
                                    case 6:
                                    case 0:
                                        e = [0, 1, 2];
                    ...
                    this.showPicker = function () {
                        if (!z()) {
                            var a = jscolor.getElementPos(c), b = jscolor.getElementSize(c), e = jscolor.getViewPos(), g = jscolor.getViewSize(), l = m(this), h, f, n;
                            ...
                            var k = (b[f] + l[f]) / 2, a = this.pickerSmartPosition ? [-e[h] + a[h] + l[h] > g[h] ? -e[h] + a[h] + b[h] / 2 > g[h] / 2 && 0 <= a[h] + b[h] - l[h] ? a[h] + b[h] - l[h] : a[h] : a[h], -e[f] + a[f] + b[f] + l[f] - k + k * n > g[f] ? -e[f] + a[f] + b[f] / 2 > g[f] / 2 && 0 <= a[f] + b[f] - k - k * n ? a[f] + b[f] - k - k * n : a[f] + b[f] - k + k * n : 0 <= a[f] + b[f] - k + k * n ? a[f] + b[f] - k + k * n : a[f] + b[f] - k - k * n] : [a[h], a[f] + b[f] - k + k * n];
                            h = a[h];
                            f = a[f];
                            if (!jscolor.picker) {
                                jscolor.picker = {
                            ...
                            "ontouchstart"in window && a.box.addEventListener("touchmove", function (a) {
                                var b = {offsetX: a.touches[0].pageX - s.X, offsetY: a.touches[0].pageY - s.Y};
                            ...
                            "ontouchstart"in window && a.padM.addEventListener("touchstart", function (a) {
                                s = {X: a.target.offsetParent.offsetLeft, Y: a.target.offsetParent.offsetTop};
                                this.onmousedown({offsetX: a.touches[0].pageX - s.X, offsetY: a.touches[0].pageY - s.Y})
                            });
                    ...
                    this.fromRGB = function (a, c, d, e) {
                        ...
                        var g = null === d ? this.rgb[2] : d, h = Math.min(Math.min(a, c), g);
                    ...
                    var d = this, p = "hvs" === this.pickerMode.toLowerCase() ? 1 : 0, y = !1, j = jscolor.fetchElement(this.valueElement), g = jscolor.fetchElement(this.styleElement), q = !1, r = !1, s = {}, v = 1, E = 2, D = 4, u = 8;
            ...
            $('#logoPosition').find('select').change(function () {
                $header
                    .removeClass('logo_left')
                    .removeClass('logo_right')
                    .addClass($(this).find('option:selected').data('value'));
            });

            $('#searchBox').find('select').change(function () {
                if ($(this).find('option:selected').data('value') == 'yes')
            ...
            $('#navigationShop').find('select').change(function () {
                if ($(this).find('option:selected').data('value') == 'yes')
                    $menu.removeClass('cartfalse').addClass('carttrue');
                else
                    $menu.addClass('cartfalse').removeClass('carttrue');
            });
            ...
            $('#bgImage').find('select').change(function () {
                ...
                switch ($(this).find('option:selected').data('value')) {
                    case 'bg0':
                        ...
                        break;
                    case 'bg1':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/bg/bg1.jpg')");
                        break;
                    case 'bg2':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/bg/bg2.jpg')");
                        break;
                    case 'bg3':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/bg/b3.jpg')");
                        break;
                    case 'bg4':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/bg/bg4.jpg')");
                        break;
                    case 'bg5':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/bg/bg5.jpg')");
                        break;
                    case 'bg6':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/bg/bg6.jpg')");
                        break;
                }
                ;
            });
            ...
            $('#bgPattern').find('select').change(function () {
                ...
                switch ($(this).find('option:selected').data('value')) {
                    case 'pt0':
                        ...
                        break;
                    case 'pt1':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/pt/pt1.png')");
                        break;
                    case 'pt2':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/pt/pt2.png')");
                        break;
                    case 'pt3':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/pt/pt3.png')");
                        break;
                    case 'pt4':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/pt/pt4.png')");
                        break;
                    case 'pt5':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/pt/pt5.png')");
                        break;
                    case 'pt6':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/pt/pt6.png')");
                        break;
                    case 'pt7':
                        $html.css('background-image', "url('http://demo.krownthemes.com/goodwork/wp-content/themes/goodwork/images/pt/pt7.png')");
                        break;
                }
                ;
            });
            ...
            $('#footerType').find('select').change(function () {
                if ($(this).find('option:selected').data('value') == 'full')
                    $footer.show()
                else
                    $footer.hide();
            });
