        ...
        return this.each(function () {
            ...
            if (!f) {
                ...
                a.each(b.data, function (a, c) {
                    ...
                    m.append("<li>" + '<a class="dd-option' + (c.disabled ? ' noclick' : "") + '">' + (c.value ? ' <input class="dd-option-value" type="hidden" value="' + c.value + '" />' : "") + (c.value ? ' <input class="dd-option-price" type="hidden" value="' + c.price + '" />' : "") + (c.imageSrc ? ' <img class="dd-option-image' + (b.imagePosition == "right" ? " dd-image-right" : "") + '" src="' + c.imageSrc + '" />' : "") + (c.text ? ' <label class="dd-option-text">' + c.text + "</label>" : "") + (c.description ? ' <small class="dd-option-description dd-desc">' + c.description + "</small>" : "") + "</a>" + "</li>")
                });
